...
data_dir = f'../../../data/images/{DATE}_r{RUN_NO}_{PROMOTER}_atc_titration/'
...
if len(growth_clists) != 0:
    print('Processing lineages...')
    ...
    print('No lineage files found! Proceeding...')
# ##############################################################################
# SNAPS PROCESSING
# ##############################################################################
snap_dfs = []
# Isolate the folders. 
samps = glob.glob(f'{data_dir}/*/')
